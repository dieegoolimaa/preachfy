...
export class SermonService {
    ...
    async updateSermon(id: string, data: Prisma.SermonUpdateInput): Promise<Sermon> {
    ...
    async syncFullSermon(sermonId: string, blocks: any[]): Promise<void> {
        await this.prisma.block.deleteMany({ where: { sermonId } });
        ...
        const blocks = [
            {
                ...
                order: 0,
                metadata: { font: 'font-serif', depth: 0, parentVerseId: '7', bibleSourceId: 'src-david-1' },
            ...
            },
            {
                ...
                order: 1,
                metadata: { font: 'font-sans', depth: 0, parentVerseId: '7', bibleSourceId: 'src-david-1' },
                sermonId: davidSermon.id
            },
            {
                type: 'ILUSTRACAO',
            ...
            },
            {
                ...
                order: 4,
                metadata: { font: 'font-serif', depth: 0, parentVerseId: '45', bibleSourceId: 'src-david-2' },
                sermonId: davidSermon.id
            },
            {
                type: 'ENFASE',
            ...
            {
                type: 'APLICACAO',
                content: 'A autoridade espiritual vale mais que qualquer armadura de bronze.',
                order: 6,
                metadata: { font: 'font-modern', depth: 1 },
                sermonId: davidSermon.id
            },
            {
                ...
                order: 7,
                metadata: { font: 'font-serif', depth: 0, parentVerseId: '13', bibleSourceId: 'src-david-3' },
                sermonId: davidSermon.id
            },
            {
                type: 'EXEGESE',
                content: 'O arrependimento sincero é a marca do homem segundo o coração de Deus.',
                order: 8,
                metadata: { font: 'font-sans', depth: 0, parentVerseId: '13', bibleSourceId: 'src-david-3' },
                sermonId: davidSermon.id
            },
            {
                type: 'ENFASE',
